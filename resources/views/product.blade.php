                    ...
                    <div class="col-sm-7 col-md-7 information-entry">
                        <div class="product-detail-box">
                            ...
                            <div class="rating-box">
                                ...
                                <div class="rating-number">{{\App\Review::where('productid',$productdata->id)->count()}} Rating</div>
                            </div>
                            ...
                            <div class="detail-info-entry">
                                <a href="{{route('product.click',$productdata->id)}}" target="_blank" class="button style-10">Info</a>
                                <div class="clear"></div>
                            </div>
                        ...
                        <div role="tabpanel" class="tab-pane" id="reviews">
                            ...
                            <form method="POST" action="{{route('review.submit')}}">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <textarea name="review" rows="6" placeholder="Message" class="form-control"></textarea>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <article class="col-item">
                            ...
                            <div class="info">
                                ...
                                <div class="separator clear-left text-center">
                                    <a href="{{url('/product')}}/{{$product->id}}/{{str_replace(' ','-',strtolower($product->title))}}" class="button style-10">Unknown</a>
