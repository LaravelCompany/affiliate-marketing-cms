                                  ...
                                  <div class="dashboard-header-area">
                                    <div class="row">
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                            <a href="{{url('admin/products')}}" class="title-stats title-blue">
                                                <div class="icon"><i class="fa fa-fw fa-shopping-cart fa-5x"></i></div>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                            <a href="{{url('admin/subscribers')}}" class="title-stats title-green">
                                                <div class="icon"><i class="fa fa-fw fa-group fa-5x"></i></div>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                            <a href="{{url('admin/sliders')}}" class="title-stats title-red">
                                                <div class="icon"><i class="fa fa-fw fa-photo fa-5x"></i></div>
                                                <div class="number">{{ \App\Slider::count() }}</div>
                                                <h4>Total Sliders!</h4>
                                                <span class="title-view-btn">View All</span>
                                            </a>
                                        </div>
