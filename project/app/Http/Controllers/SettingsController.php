...
class SettingsController extends Controller
{
    ...
    public function title(Request $request)
    {
        ...
        DB::table('settings')
            ->where('id', 1)
            ->update(['title' => $request->title, 'sign' => $request->sign]);
    ...
    public function payment(Request $request)
    {
        ...
        DB::table('settings')
            ->where('id', 1)
            ->update(['sign' => $request->sign,'paypal_business' => $request->paypal,'stripe_key' => $request->stripe_key,'stripe_secret' => $request->stripe_secret]);
